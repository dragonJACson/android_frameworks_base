...
import static mokee.providers.MKSettings.System.STATUS_BAR_SHOW_BATTERY_PERCENT;
...
public class BatteryMeterView extends LinearLayout implements
    ...
    public static final String STATUS_BAR_BATTERY_STYLE =
            "mksystem:" + MKSettings.System.STATUS_BAR_BATTERY_STYLE;
    ...
    private int mBatteryStyle = BATTERY_STYLE_CIRCLE;
        ...
        mUserTracker = new CurrentUserTracker(mContext) {
            ...
            public void onUserSwitched(int newUserId) {
                ...
                getContext().getContentResolver().registerContentObserver(
                        MKSettings.System.getUriFor(STATUS_BAR_SHOW_BATTERY_PERCENT),
    ...
    private void updateShowPercent() {
        ...
        final boolean drawPercentInside = 1 == MKSettings.System
                .getIntForUser(getContext().getContentResolver(),
                STATUS_BAR_SHOW_BATTERY_PERCENT, 1, mUser);
        final boolean showPercent = 2 == MKSettings.System
                .getIntForUser(getContext().getContentResolver(),
