...
public class StatusBar extends SystemUI implements DemoMode, TunerService.Tunable,
    ...
    protected void updateTheme() {
        ...
        final int globalStyleSetting = MKSettings.System.getInt(mContext.getContentResolver(),
                MKSettings.System.BERRY_GLOBAL_STYLE, 0);
    ...
    public void onTuningChanged(String key, String newValue) {
        if (SCREEN_BRIGHTNESS_MODE.equals(key)) {
            ...
            boolean forcedVisibility = mNeedsNavigationBar || isForceShowNavbarEnabled();

            if (useGestureButton) {
                if (isForceShowNavbarEnabled()) {
                    MKSettings.System.putIntForUser(mContext.getContentResolver(),
