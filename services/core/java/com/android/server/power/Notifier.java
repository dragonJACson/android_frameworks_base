...
final class Notifier {
    ...
    private void playChargingStartedSound() {
        final String soundPath = MKSettings.Global.getString(mContext.getContentResolver(),
    ...
    private void playChargingVibration(boolean dockedOnWirelessCharger) {
        final boolean vibrateEnabled = MKSettings.Global.getInt(mContext.getContentResolver(),
